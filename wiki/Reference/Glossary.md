...
A reference for the recurring terms, stat abbreviations and game-specific jargon used across this wiki, grouped by topic. Combat keywords are defined in full on [Battle Mechanics](../Mechanics/Battle-Mechanics.md) and [Status Effects](../Mechanics/Status-Effects.md).
