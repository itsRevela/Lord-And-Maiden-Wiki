...
Crowd-control and status definitions used throughout combat. See [Battle Mechanics](Battle-Mechanics.md) for how skills apply them and [Buffs & Debuffs](Buffs.md) for the data catalog.
