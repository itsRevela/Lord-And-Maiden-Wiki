...
**Rarity:** ★3  ·  **Race:** Human  ·  **Role:** DPS  ·  **Archetype (RST):** Archer (ATK + Ruin)

## Profile
Height 155cm · Age 14 · Birthday 7/7 · Character: Sensitive,Delicate · Interest: Tend flowers

## Voice Lines
| Line | Text |
|---|---|
| Summon | Puppet Zero, personality program regeneration, are you my master? |
| Tap 1 | Please give orders... |
| Tap 2 | ... The master... Take me home... ' |
| Tap 3 | Confirm the command and start the combat mode |
