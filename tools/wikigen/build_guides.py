...
def gen_spending(write, tbl, R):
    ...
    lines += [
        ...
        "[Shops](Shops.md) and [Recharge & Gift Packs](Recharge-Packs.md). *(Prices show in USD for "
        "English players; other-currency conversions can be unfavourable.)*", "",
        "## Best value purchases",
        "- **Growth Fund** — lots of gems as you level; the **best gem value**.",
        "- **$5 Monthly Card** — gems mailed every day; the best ongoing value.",
        "- **Prestige gift pack (Pomon)** — a strong early hero that smooths the early game (skip if you "
        "rerolled a good starter on mobile).",
